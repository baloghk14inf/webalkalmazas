<div class="container-fluid">
    ...
    <div class="row">
        <h4 class="text-center l-r-cim" >Dokumentum keresése</h4>
        <div class="row">
            <form class="form-container"  role="form" id='form-dokumentum-listazas'> 
                    <div class="form-group col-sm-12 col-lg-3 feltolteseim-frm" >
                        <label for="targy">Tárgy</label>
                        <select class="form-control input-sm" name="targy" id="dokumentum_k_targy">
                    ...
                    <div class="form-group col-sm-12 col-lg-3 feltolteseim-frm" >
                        ...
                        <select class="form-control input-sm" name="kategoria" id="dokumentum_k_kategoria">
                        <option value="">-- Kiválaszt --</option>
                    ...
                    <div class="form-group col-sm-12 col-lg-3 feltolteseim-frm">
                        ...
                        <input type="text" class="form-control input-sm" name="datum" id="datum" >
                    </div>
            </form>
        </div>
        <div class="row">
